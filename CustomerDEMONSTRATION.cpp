...
void addData(BST<Customer> &, BST<Customer> &, LinkedList<Customer> &, LinkedList<Customer> &, HashTable<Customer> &);
...
int main()
{
    ...
    while (repeat)
    {
        try
        {
            ...
            {
                cout << "Enter an option between 0 and 11." << endl;
            }
            clarityLine(cout);
            ...
            case(1):
            {
                ...
                while (repeat == "1")
                {
                    ...
                    addData(phoneNumBST, emailBST, amtSpentLL, nearbyRestsLL, phoneNumHT);
...
Return:
*/
void addData(BST<Customer> &phoneNumBST, BST<Customer> &emailBST, LinkedList<Customer> &amtSpentLL, LinkedList<Customer> &nearbyRestsLL, HashTable<Customer> &phoneNumHT)
{
    string phoneNum = "";
    string name = "";
    string email = "";
